// Generated from: tests/features/0002-project-foundation.feature
...
test.describe('Project Foundation', () => {
  ...
  test('Navigation works', async ({ Given, When, Then, page }) => { 
    ...
    await Then('I navigate to the scan page', null, { page }); 
  });
...
test.use({
  ...
  $uri: [({}, use) => use('tests/features/0002-project-foundation.feature'), { scope: 'test', box: true }],
